...
static paging_pml4_entry_t *paging_kernel_pml4;

void paging_initialize()
{
  // Load the current PML4 location into paging_kernel_pml4.
  // This will be used as the basis for further pagesets.
  __asm__ volatile("mov %%cr3, %0" : "=r" (paging_kernel_pml4));

  // Remove our identity map at 0 - 2 MB. We don't need it anymore.
  memory_set(&paging_kernel_pml4[0], 0, sizeof(paging_pml4_entry_t));
